...
/**
 * @author ：JJHu
 * @date ：Created in 2020/12/1 16:05
 * @description：
 * @modified By：
 * @version: $
 */
...
public class AdminMainController implements Initializable {
    ...
    void init() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                Parent parent = adminMainView.getView();
                AdminMainController.this.stage = (Stage) parent.getScene().getWindow();
                stage.setWidth(1280);
                stage.setHeight(760);
    ...
    //录入用户信息
    @FXML
    public void handleEnterUserInfo() {
        //平面
    ...
    //按人员查询基本信息
    @FXML
    public void handleQueryInfoByPerson(ActionEvent actionEvent) {
        stage.setWidth(1125);
        stage.setHeight(705);
        stage.setResizable(false);
